...
@controller.route("/steven", methods=["GET"])
def _user():
...
@controller.route("/rebecca", methods=["GET"])
def __user():
    user = _getUser()
...
@controller.route("/steven/addprescription", methods=["POST"])
def _add():
...
@controller.route("/steven/deleteprescription", methods=["POST"])
def _delete():
...
@controller.route("/steven/updateprescription", methods=["POST"])
def _update():
    medicines = app.redis.keys("steven:medicine:*")
    _id = flask.request.form["_id"]
